...
def create_model(max_frames):
    numClasses=20
    model=Sequential()
    model.add(InputLayer(input_shape=(max_frames, 10, 1)))
...
in_files = '/home/will/avp_cw2/testing_features/audio_mfcc_features/*.npy'
max_frames = 214
...
model.load_weights('/home/will/avp_cw2/models/audio_model/weights/names.weights.h5')
